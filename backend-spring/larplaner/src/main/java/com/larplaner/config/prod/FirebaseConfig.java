...
public class FirebaseConfig {
  ...
  /**
   * This preferably should be JSON file as in development configuration,
   * however there is some issue with Render secure files configuration,
   * so setting this JSON as env variable is my workaround
   */
